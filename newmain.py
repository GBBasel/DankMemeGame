...
#Für jeden PC anders
PATH_TO_FILE = 'C:\Users\\vince\\OneDrive\\Documents\\Bäumlihof\\5Bb\\Informatik\\DankMemeGame\\'
...
class Dino(Actor):
    ...
    def act(self):
        if self.inAir:
            ...
            # wenn man eine taste drückt und der dino nicht fällt, fällt er langsamer 
    ...
    def game_over(self):
        self.gameOver = True
        self.gameOverText = TextActor("Game Over Score: {}".format(self.score), Color.BLACK, Color.WHITE, Font("Arial", Font.BOLD, 60))
...
class Vogel(Gegner):
    ...
    def act(self):
        #ändert zufällig seine richtung
...
gegnersliste = [] # speichert alle gegner um sie spàter zu löschen


#Game Loop
while not isDisposed():
    # Boss Spawn
    if time.time()-dino.startTime > 30 and not boss.aktive and not boss.onespawned: 
        #init boss
        boss.aktive = True
